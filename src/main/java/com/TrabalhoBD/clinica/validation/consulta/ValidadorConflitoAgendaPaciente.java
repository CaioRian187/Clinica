...
@Component
public class ValidadorConflitoAgendaPaciente extends ValidadorConsultaBase {
    ...
    public void validar(Consulta consulta) {
        ...
        List<Consulta> consultasPaciente =
            consultaRepository.findByPaciente_id(consulta.getPaciente().getId());
        ...
        List<Exame> examesPaciente =
            exameRepository.findByPaciente_id(consulta.getPaciente().getId());
